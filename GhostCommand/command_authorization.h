...
private:
    ...
    // Smart pointer to manage GhostAuth instance, allowing user authentication tasks
    std::shared_ptr<GhostAuth> ghostAuth;

    // Smart pointer to manage OQS_SIG lifecycle for post-quantum signature operations
